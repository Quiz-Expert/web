        ...
        <div class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 align-middle w-full max-w-lg">
                ...
                <div class="grid grid-cols-3 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    <label for="name"
                           ...
                           v-text="$t('pages.dashboard.suggestions-panel.edition.name')"
                    />
                    <input id="name"
                           type="text"
                           name="name"
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="about"
                           class="block text-sm font-medium text-gray-700"
                           v-text="$t('pages.dashboard.suggestions-panel.edition.description')"
                    />
                    <div class="mt-1">
                      <textarea id="about"
                                name="about"
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label class="block text-sm font-medium text-gray-700"
                           v-text="$t('pages.dashboard.suggestions-panel.edition.photo')"
                    />
                    <div class="mt-1 flex items-center">
                      ...
                      <button type="button"
                              ...
                              v-text="$t('pages.dashboard.suggestions-panel.edition.change-photo')"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button type="button"
                    ...
                    v-text="$t('pages.dashboard.suggestions-panel.edition.save')"
            />
            <button type="button"
